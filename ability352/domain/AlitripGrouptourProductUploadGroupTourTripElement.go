...
type AlitripGrouptourProductUploadGroupTourTripElement struct {
    /*
        必填，第几天的行程信息     */
...
func (s *AlitripGrouptourProductUploadGroupTourTripElement) SetDay(v int64) *AlitripGrouptourProductUploadGroupTourTripElement {
    s.Day = &v
    return s
}
func (s *AlitripGrouptourProductUploadGroupTourTripElement) SetType(v int64) *AlitripGrouptourProductUploadGroupTourTripElement {
    s.Type = &v
    return s
}
func (s *AlitripGrouptourProductUploadGroupTourTripElement) SetJsonStr(v string) *AlitripGrouptourProductUploadGroupTourTripElement {
    s.JsonStr = &v
    return s
}
