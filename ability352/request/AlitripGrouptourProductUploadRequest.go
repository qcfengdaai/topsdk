...
type AlitripGrouptourProductUploadRequest struct {
    ...
    GroupTourPackageInfo  *[]domain.AlitripGrouptourProductUploadGroupTourPackageInfo `json:"group_tour_package_info,omitempty" required:"false" `
    /*
    ...
    /*
        0：使用上传的套餐信息（group_tour_package_info）覆盖商品上原有的套餐信息（此时group_tour_package_info中设置的packageOperation无效）；1：根据套餐信息（group_tour_package_info）中的packageOperation和outProductId增加，修改，删除指定套餐，====默认值为0=== defalutValue��0    */
    ...
    GroupTourType  *int64 `json:"group_tour_type,omitempty" required:"false" `
    /*
...
func (s *AlitripGrouptourProductUploadRequest) SetGoTrafficType(v int64) *AlitripGrouptourProductUploadRequest {
    s.GoTrafficType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetTripDay(v int64) *AlitripGrouptourProductUploadRequest {
    s.TripDay = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetWapDesc(v string) *AlitripGrouptourProductUploadRequest {
    s.WapDesc = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetSubStock(v int64) *AlitripGrouptourProductUploadRequest {
    s.SubStock = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetBackTrafficType(v int64) *AlitripGrouptourProductUploadRequest {
    s.BackTrafficType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetDescXml(v string) *AlitripGrouptourProductUploadRequest {
    s.DescXml = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetConfirmTime(v int64) *AlitripGrouptourProductUploadRequest {
    s.ConfirmTime = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetTitle(v string) *AlitripGrouptourProductUploadRequest {
    s.Title = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetRouteType(v int64) *AlitripGrouptourProductUploadRequest {
    s.RouteType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetRefundRegulations(v []string) *AlitripGrouptourProductUploadRequest {
    s.RefundRegulations = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetGroupTourPackageInfo(v []domain.AlitripGrouptourProductUploadGroupTourPackageInfo) *AlitripGrouptourProductUploadRequest {
    s.GroupTourPackageInfo = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetConfirmType(v int64) *AlitripGrouptourProductUploadRequest {
    s.ConfirmType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetItemCustomTag(v string) *AlitripGrouptourProductUploadRequest {
    s.ItemCustomTag = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetOutProductId(v string) *AlitripGrouptourProductUploadRequest {
    s.OutProductId = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetTripNight(v int64) *AlitripGrouptourProductUploadRequest {
    s.TripNight = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetToLocations(v string) *AlitripGrouptourProductUploadRequest {
    s.ToLocations = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetPicUrls(v []string) *AlitripGrouptourProductUploadRequest {
    s.PicUrls = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetReserveLimit(v string) *AlitripGrouptourProductUploadRequest {
    s.ReserveLimit = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetItemId(v int64) *AlitripGrouptourProductUploadRequest {
    s.ItemId = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetRefundType(v int64) *AlitripGrouptourProductUploadRequest {
    s.RefundType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetSubTitles(v []string) *AlitripGrouptourProductUploadRequest {
    s.SubTitles = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetFromLocations(v string) *AlitripGrouptourProductUploadRequest {
    s.FromLocations = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetDescHtml(v string) *AlitripGrouptourProductUploadRequest {
    s.DescHtml = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetTravellerTemplateId(v int64) *AlitripGrouptourProductUploadRequest {
    s.TravellerTemplateId = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetIsOverseasTour(v int64) *AlitripGrouptourProductUploadRequest {
    s.IsOverseasTour = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetPurePlay(v int64) *AlitripGrouptourProductUploadRequest {
    s.PurePlay = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetRefundRegulationsJson(v string) *AlitripGrouptourProductUploadRequest {
    s.RefundRegulationsJson = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetPackageOperation(v int64) *AlitripGrouptourProductUploadRequest {
    s.PackageOperation = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetGroupTourType(v int64) *AlitripGrouptourProductUploadRequest {
    s.GroupTourType = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetSellerCids(v []string) *AlitripGrouptourProductUploadRequest {
    s.SellerCids = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetSecondKill(v string) *AlitripGrouptourProductUploadRequest {
    s.SecondKill = &v
    return s
}
func (s *AlitripGrouptourProductUploadRequest) SetHasDiscount(v bool) *AlitripGrouptourProductUploadRequest {
    s.HasDiscount = &v
    return s
}

func (req *AlitripGrouptourProductUploadRequest) ToMap() map[string]interface{} {
    ...
    if(req.GroupTourPackageInfo != nil) {
        paramMap["group_tour_package_info"] = util.ConvertStructList(*req.GroupTourPackageInfo)
    }
    ...
    if(req.GroupTourType != nil) {
        paramMap["group_tour_type"] = *req.GroupTourType
    }
...
func (req *AlitripGrouptourProductUploadRequest) ToFileMap() map[string]interface{} {
