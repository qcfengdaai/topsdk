...
type AlitripDaytoursProductUploadRequest struct {
    ...
    /*
        真实的旅游服务提供商     */
    TouristServiceProvider  *string `json:"tourist_service_provider,omitempty" required:"false" `
    /*
    ...
    StructItineraries  *[]domain.AlitripDaytoursProductUploadStructItinerary `json:"struct_itineraries,omitempty" required:"false" `
    /*
        一日游 产品亮点     */
    HighLights  *[]domain.AlitripDaytoursProductUploadProductHighLights `json:"high_lights,omitempty" required:"false" `
    /*
    ...
    BusinessLicense  *string `json:"business_license,omitempty" required:"false" `
    /*
...
func (s *AlitripDaytoursProductUploadRequest) SetTripDay(v int64) *AlitripDaytoursProductUploadRequest {
    s.TripDay = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetSubStock(v int64) *AlitripDaytoursProductUploadRequest {
    s.SubStock = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetWapDesc(v string) *AlitripDaytoursProductUploadRequest {
    s.WapDesc = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetItineraries(v []string) *AlitripDaytoursProductUploadRequest {
    s.Itineraries = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetDescXml(v string) *AlitripDaytoursProductUploadRequest {
    s.DescXml = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetFeeExclude(v []string) *AlitripDaytoursProductUploadRequest {
    s.FeeExclude = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetOrderInfo(v []string) *AlitripDaytoursProductUploadRequest {
    s.OrderInfo = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetConfirmTime(v int64) *AlitripDaytoursProductUploadRequest {
    s.ConfirmTime = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetTitle(v string) *AlitripDaytoursProductUploadRequest {
    s.Title = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetRefundRegulations(v []string) *AlitripDaytoursProductUploadRequest {
    s.RefundRegulations = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetFeeInclude(v []string) *AlitripDaytoursProductUploadRequest {
    s.FeeInclude = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetConfirmType(v int64) *AlitripDaytoursProductUploadRequest {
    s.ConfirmType = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetItemCustomTag(v string) *AlitripDaytoursProductUploadRequest {
    s.ItemCustomTag = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetOutProductId(v string) *AlitripDaytoursProductUploadRequest {
    s.OutProductId = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetToLocations(v string) *AlitripDaytoursProductUploadRequest {
    s.ToLocations = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetTripNight(v int64) *AlitripDaytoursProductUploadRequest {
    s.TripNight = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetPicUrls(v []string) *AlitripDaytoursProductUploadRequest {
    s.PicUrls = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetItemId(v int64) *AlitripDaytoursProductUploadRequest {
    s.ItemId = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetReserveLimit(v string) *AlitripDaytoursProductUploadRequest {
    s.ReserveLimit = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetRefundType(v int64) *AlitripDaytoursProductUploadRequest {
    s.RefundType = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetFromLocations(v string) *AlitripDaytoursProductUploadRequest {
    s.FromLocations = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetDescHtml(v string) *AlitripDaytoursProductUploadRequest {
    s.DescHtml = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetSubTitles(v []string) *AlitripDaytoursProductUploadRequest {
    s.SubTitles = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetTravellerTemplateId(v int64) *AlitripDaytoursProductUploadRequest {
    s.TravellerTemplateId = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetTouristServiceProvider(v string) *AlitripDaytoursProductUploadRequest {
    s.TouristServiceProvider = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetStructItineraries(v []domain.AlitripDaytoursProductUploadStructItinerary) *AlitripDaytoursProductUploadRequest {
    s.StructItineraries = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetHighLights(v []domain.AlitripDaytoursProductUploadProductHighLights) *AlitripDaytoursProductUploadRequest {
    s.HighLights = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetRefundRegulationsJson(v string) *AlitripDaytoursProductUploadRequest {
    s.RefundRegulationsJson = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetBusinessLicense(v string) *AlitripDaytoursProductUploadRequest {
    s.BusinessLicense = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetSellerCids(v []string) *AlitripDaytoursProductUploadRequest {
    s.SellerCids = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetSecondKill(v string) *AlitripDaytoursProductUploadRequest {
    s.SecondKill = &v
    return s
}
func (s *AlitripDaytoursProductUploadRequest) SetHasDiscount(v bool) *AlitripDaytoursProductUploadRequest {
    s.HasDiscount = &v
    return s
}

func (req *AlitripDaytoursProductUploadRequest) ToMap() map[string]interface{} {
    ...
    if(req.TouristServiceProvider != nil) {
        paramMap["tourist_service_provider"] = *req.TouristServiceProvider
    }
...
func (req *AlitripDaytoursProductUploadRequest) ToFileMap() map[string]interface{} {
