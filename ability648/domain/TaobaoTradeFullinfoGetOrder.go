...
type TaobaoTradeFullinfoGetOrder struct {
    ...
    /*
        订单是否属于b2b代销     */
    B2bDaixiao  *string `json:"b2b_daixiao,omitempty" `

    /*
        发货信息，目前只记录了发货方式     */
    ShipInfo  *[]TaobaoTradeFullinfoGetShipInfo `json:"ship_info,omitempty" `

    /*
        组合品信息     */
    CombineItemInfo  *[]TaobaoTradeFullinfoGetCombineSubItemDO `json:"combine_item_info,omitempty" `
    ...
    /*
        套餐购套餐名称     */
    BundleOutName  *string `json:"bundle_out_name,omitempty" `

    /*
        套餐购套餐类型标识 1营销套餐-PromoBundle 2人群套餐-CrowdBundle     */
    BundleType  *int64 `json:"bundle_type,omitempty" `

    /*
        主品关联的1元商品订单号     */
    OneYuanReservationOrders  *string `json:"one_yuan_reservation_orders,omitempty" `

    /*
        是否家装分销订单，入参fields中传入orders.is_jzfx时返回     */
    IsJzfx  *bool `json:"is_jzfx,omitempty" `

    /*
        鉴定编码     */
    JewccNo  *string `json:"jewcc_no,omitempty" `
...
func (s *TaobaoTradeFullinfoGetOrder) SetB2bDaixiao(v string) *TaobaoTradeFullinfoGetOrder {
    s.B2bDaixiao = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetShipInfo(v []TaobaoTradeFullinfoGetShipInfo) *TaobaoTradeFullinfoGetOrder {
    s.ShipInfo = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetCombineItemInfo(v []TaobaoTradeFullinfoGetCombineSubItemDO) *TaobaoTradeFullinfoGetOrder {
    s.CombineItemInfo = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetNeedReturn(v bool) *TaobaoTradeFullinfoGetOrder {
    s.NeedReturn = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetBundleId(v string) *TaobaoTradeFullinfoGetOrder {
    s.BundleId = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetBundleOutName(v string) *TaobaoTradeFullinfoGetOrder {
    s.BundleOutName = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetBundleType(v int64) *TaobaoTradeFullinfoGetOrder {
    s.BundleType = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetOneYuanReservationOrders(v string) *TaobaoTradeFullinfoGetOrder {
    s.OneYuanReservationOrders = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetIsJzfx(v bool) *TaobaoTradeFullinfoGetOrder {
    s.IsJzfx = &v
    return s
}
func (s *TaobaoTradeFullinfoGetOrder) SetJewccNo(v string) *TaobaoTradeFullinfoGetOrder {
    s.JewccNo = &v
    return s
}
