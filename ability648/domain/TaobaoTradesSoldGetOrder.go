...
type TaobaoTradesSoldGetOrder struct {
    ...
    /*
        发货信息，目前只记录了发货方式     */
    ShpInfo  *[]TaobaoTradesSoldGetShipInfo `json:"shp_info,omitempty" `
...
func (s *TaobaoTradesSoldGetOrder) SetShpInfo(v []TaobaoTradesSoldGetShipInfo) *TaobaoTradesSoldGetOrder {
    s.ShpInfo = &v
    return s
}
