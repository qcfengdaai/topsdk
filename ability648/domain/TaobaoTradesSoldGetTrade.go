...
type TaobaoTradesSoldGetTrade struct {
    ...
    /*
        物流服务承诺     */
    LogisticsAgreement  *TaobaoTradesSoldGetLogisticsAgreement `json:"logistics_agreement,omitempty" `

    /*
        子单维度物流发货信息     */
    LogisticsInfos  *[]TaobaoTradesSoldGetLogisticsInfo `json:"logistics_infos,omitempty" `
...
func (s *TaobaoTradesSoldGetTrade) SetLogisticsAgreement(v TaobaoTradesSoldGetLogisticsAgreement) *TaobaoTradesSoldGetTrade {
    s.LogisticsAgreement = &v
    return s
}
func (s *TaobaoTradesSoldGetTrade) SetLogisticsInfos(v []TaobaoTradesSoldGetLogisticsInfo) *TaobaoTradesSoldGetTrade {
    s.LogisticsInfos = &v
    return s
}
