...
type TaobaoTradeFullinfoGetTrade struct {
    ...
    /*
        子订单组合品物流详情（仅支持拆单发货）     */
    CombineLogisticsDetails  *[]TaobaoTradeFullinfoGetCombineLogisticsDetail `json:"combine_logistics_details,omitempty" `

    /*
        三方鉴定信息     */
    IdentifyInfo  *TaobaoTradeFullinfoGetIdentifyInfo `json:"identify_info,omitempty" `

    /*
        物流时效信息     */
    LogisticsConsignInfo  *[]TaobaoTradeFullinfoGetLogisticsConsignInfo `json:"logistics_consign_info,omitempty" `

    /*
        发货时效修改记录     */
    LogisticsModifyInfo  *[]TaobaoTradeFullinfoGetLogisticsModifyInfo `json:"logistics_modify_info,omitempty" `

    /*
        优先发货时间     */
    PriorityConsignTime  *string `json:"priority_consign_time,omitempty" `

    /*
        物流服务     */
    LogisticsAgreement  *TaobaoTradeFullinfoGetLogisticsAgreement `json:"logistics_agreement,omitempty" `

    /*
        天猫国际实名认证状态，1：实名完成 0：实名未完成     */
    RealNameAuthStatus  *string `json:"real_name_auth_status,omitempty" `

    /*
        天猫国际第三方报关标识，1：第三方报关 0：非第三方报关     */
    ThirdPartyCustomsDeclaration  *string `json:"third_party_customs_declaration,omitempty" `
    ...
    /*
        补差关联订单号列表     */
    ReceiptRelIds  *[]string `json:"receipt_rel_ids,omitempty" `
...
func (s *TaobaoTradeFullinfoGetTrade) SetCombineLogisticsDetails(v []TaobaoTradeFullinfoGetCombineLogisticsDetail) *TaobaoTradeFullinfoGetTrade {
    s.CombineLogisticsDetails = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetIdentifyInfo(v TaobaoTradeFullinfoGetIdentifyInfo) *TaobaoTradeFullinfoGetTrade {
    s.IdentifyInfo = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetLogisticsConsignInfo(v []TaobaoTradeFullinfoGetLogisticsConsignInfo) *TaobaoTradeFullinfoGetTrade {
    s.LogisticsConsignInfo = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetLogisticsModifyInfo(v []TaobaoTradeFullinfoGetLogisticsModifyInfo) *TaobaoTradeFullinfoGetTrade {
    s.LogisticsModifyInfo = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetPriorityConsignTime(v string) *TaobaoTradeFullinfoGetTrade {
    s.PriorityConsignTime = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetLogisticsAgreement(v TaobaoTradeFullinfoGetLogisticsAgreement) *TaobaoTradeFullinfoGetTrade {
    s.LogisticsAgreement = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetRealNameAuthStatus(v string) *TaobaoTradeFullinfoGetTrade {
    s.RealNameAuthStatus = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetThirdPartyCustomsDeclaration(v string) *TaobaoTradeFullinfoGetTrade {
    s.ThirdPartyCustomsDeclaration = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetReceiptType(v string) *TaobaoTradeFullinfoGetTrade {
    s.ReceiptType = &v
    return s
}
func (s *TaobaoTradeFullinfoGetTrade) SetReceiptRelIds(v []string) *TaobaoTradeFullinfoGetTrade {
    s.ReceiptRelIds = &v
    return s
}
